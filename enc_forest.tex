...
\person{6}% STRENGTH
	...
	{3}% DR
	{1}% COMBAT
	{Aggression 2, Academics 2, Ether Lore 3, Medicine 1\Path{Nura}{Necromancy 4, Saurecanta 3}}% SKILLS
	{\longsword}% EQUIPMENT
	{\mana{6}\addtocounter{xpbonus}{3}}
...
They speak an old fashioned version of the language of their Realm, and Elvish.
They do not speak the Trade Tongue.
