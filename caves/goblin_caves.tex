...
Once in the water, ask the player where their character goes.


\begin{itemize}
  \item
  `\textit{I go forward}', sound sensible, but you should ask how they know which way forward is.
  Their world has gone black the moment they enter the water.
  \item
  Swimming at the top opens passage A, which extends 10 steps before a dead end.
  \item
  Swimming at the bottom leads to passage B, which leads to an exit around the bottom of the passage, which then leads up and out.
  \item
  Swimming at a middle-height leads to passage C, which leads 12 steps to a dead end.
\end{itemize}

Characters can swim for a number of \glspl{step} equal to their Seafaring Skill plus 4, times their current \glspl{hp}, minus their \glspl{fatigue}.
So a character with Seafaring 1, 8 \glspl{hp} and 3 \glspl{fatigue}, could swim for 25 steps.
