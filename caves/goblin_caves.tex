...
\act{jump over the bridge}{Speed}{Athletics}{7}
...
At this point, a goblin lying in wait attacks with an automatic \gls{vitalShot} (since the troupe are almost certainly \gls{blackWalking}).
\ifnum\value{temperature}=3%
...
\playCommentaryTorches[t]

\mapentry[blindFish]{Blind Fish Rapids}

\begin{boxtext}
  A wide crack in the ground ahead reveals a river, almost within touching distance.
...
\subsection{A Return to Sunlight}
...
\begin{boxtext}
  ...
  Small holes at the side of the cavern lead upwards towards light.
\end{boxtext}
