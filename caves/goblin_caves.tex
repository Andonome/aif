...
\begin{boxtext}
  ...
  The rope goes around the boulder like the bow on a birthday preseent, then hangs down heavily, past the floor.
\end{boxtext}
...
If the \glspl{pc} have \pgls{torch} lit, they see the walls glisten feintly, due to the silver in this section.
...
\begin{boxtext}
  The sound of gently moving water comes from ahead.
  Your hear the passage becoming wider.
  As the sound of water seems right in front of you, the ground changes.
...
\Pgls{pc} might notice with a \roll{Wits}{Vigilance} roll at \tn[8].

\begin{boxtext}
  You step on something soft.
  You feel a little hand, and a head with long ears.
\end{boxtext}
...
\paragraph{If the players don't notices the danger}
characters can roll \roll{Wits}{Caving} at \tn[10] to notice the danger.
