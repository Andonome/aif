...
Once out of the water and rested, the character can remove all \glspl{ep} from the water except 2 -- they receive \pgls{ep} for exertion, and another from the freezing-cold water.
...
The \pgls{pc} will need to vault it or swim across.
...
The goblins will wait a full two~\glspl{interval} before leaving\ldots silently.
...
This lower passage leads to 
\stateArea{skeinSwarm}.

If the troupe run up the little ledge the goblins stand on, it leads to a cavern full of large rocks, then on to
\stateArea{mushroomsTunnel}.
