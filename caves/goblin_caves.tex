...
If the \glspl{pc} made not attempt to remain quiet, he flees (and they will hear the splash).
\iftoggle{verbose}{%
  If they want to exit silently (and have no light), they can roll \roll{Dexterity}{Stealth} at \tn[10] plus the goblin's \roll{Wits}{Vigilance}.
}{}
