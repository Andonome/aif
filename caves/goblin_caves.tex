...
\begin{boxtext}[How will you find the right way?]
  ...
  Ahead, the torchlight barely illuminates another branching passage.
  Many choices lie ahead.
\end{boxtext}

Each time a player things of a reasonable way to find the exit path, reduce the \gls{tn} by 1 or~2.
