...
\ifnum\value{temperature}=0\else
  \paragraph{Throwing stones past the umber hulk}
  will make it leave the cave and search for the cause of the noise, because umber hulks are stupid, and always move towards any noises.
\fi
