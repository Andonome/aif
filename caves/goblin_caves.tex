...
\paragraph{Resting}
requires an \roll{Intelligence}{Caving} roll (\tn[10]).
Failure means the troupe waste \pgls{interval} as dust messes up their food.

\begin{boxtext}
  Everyone at the back finds they're on sharp rocks and can't lie down properly, and has to move.
  ...
  Hours have passed without rest.
\end{boxtext}
