...
If the troupe manage to back any of the goblins into a corner, their own fatigued bodies will make the fight far more challenging than they might expect.

The module will not present these scenes explicitly.
In fact, they may never arise.
However, you should make sure that the players record their characters' rations, \glspl{fatigue}, and the total \gls{weight} each character carries at all times.
