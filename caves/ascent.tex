...
\noindent
The first \gls{pc} down receives 5 rocks thrown at them, and will have to make a single roll to avoid them with \roll{Dexterity}{Athletics} (\tn[10]).
...
\paragraph{If the \glspl{pc} have not a torch,}
...
Give the players a moment to understand what has happened, and make some preparations.
Describe the scene again.

Do they have any light?
How many have survived?

Only one path remains\ldots
