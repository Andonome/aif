...
requires a \roll{Charisma}{Empathy} roll at \tn[8] (or whatever Skill seems appropriate), to convince the \glspl{sunGuard} to allow the conversation.
...
\sidebox{
  \begin{boxtable}[lX]
    ...
    \tn[6] & Mallet \\
    \tn[7] & 2 more torches \\
    \tn[9] & One extra day's \glspl{ration} \\
