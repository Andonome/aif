...
The players' general goal is to move through the mine, but then they declared resting for \pgls{interval}.
Anyone taking the role of \pgls{gm} quickly builds up an instinct to remove their own agency, and let the players declare actions; telling them `okay, now you move' seems wrong.
...
Another problem is that \pgls{interval} represents six hours.
...
This module (and the rest) comes with the necessary resolution rules at the start (\vpageref{glosPreamble}), but nothing more.
