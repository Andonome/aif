...
\begin{description}\sf
  ...
  The rest of the troupe follow behind as you scrape forwards.
  \item[Player 3:]
  How long does the narrow bit go on for?
  \item[\Glsentrytext{gm}:]
  You just keep going sideways.
  As the wall starts leaning to the side, you feel yourself leaning backwards to accommodate the slant, while you walk sideways.
  \item[Player 3:]
...
The \gls{gm} resolved this with `okay, and then you feel less exhausted', then returned back to the general goal.
