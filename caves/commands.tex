...
\newcommand\playCommentaryCaveIn{
  \playCommentary{
    \begin{description}
      \item[\Gls{gm}:]
      ...
      \else%
        a broken biscuit.
      \fi%
      Everyone roll a $D6$ -- if you roll a 1, a rock hits you.
      \item[Player 1:]
      Where did the goblins go?
      \item[\Gls{gm}:]
      There's only one passage -- they ran just ahead of you, but nobody lit \pgls{torch}, so you can't see them.
      \item[Player 1:]
      How far back?
      \item[\Gls{gm}:]
      Sixty \glspl{step}.
      \item[Player 1:]
      I'll run after the goblins!
      \dicef{1}
      Wait, I got hit by a rock!
      \item[Player 2:]
      I'm running back\ldots
      \dicef{1}
      or not.
      I got hit too.
      \item[Player 3:]
      ...
      \item[\Gls{gm}:]
      \dicef{5}
      That first rock nearly hit you on the head for 5~Damage,
      \dicef{3}
      the next one was 3~Damage.
      \item[Player 2:]
      Near miss?
      Oh right, the \glsentrylongpl{fp}.
      \item[\Gls{gm}:]
      The rock still gives you a shunt, and you lose all \glsentrylongpl{ap}.
      \item[Player 3:]
      How far can I run after the goblins?
      \item[\Gls{gm}:]
      Spend \pgls{ap} to run 3~\glspl{step} plus your Athletics.
      \item[Player 3:]
      So just 4~\glspl{step}?
      But I have 4~\glspl{ap}, so that's 4 times 4, so 16~\glspl{step}?
      \item[\Gls{gm}:]
      That's good sprinting!
      Next \gls{round}!
      Everyone roll a $D6$ -- you get hit on a 1 or 2.
      \item[Player 1:]
      \dicef{4} -- running\ldots
      3 plus Athletics times 3 plus Speed.
      That's 12 \glspl{step}.
      \item[Player 2:]
      \dicef{3}
      I'm clear, but what's my movement?
      \item[Player 3:]
      It's 6\ldots
      you are going to die.
      Can I help her move?
      \item[\Gls{gm}:]
      Only if you want to spend \pgls{round} running back.
      \item[Player 1:]
      \dicef{4}
      I can help her.
      \item[\Gls{gm}:]
      Spend \pgls{ap} each \gls{round} and she'll run at your pace.
      That's 9~\glspl{step} you can go together.
...
\newcommand\playCommentaryPuddle{
  \playCommentary{
...
\newcommand\playCommentaryDrowning{
  \playCommentary{
