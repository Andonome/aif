...
Grawlix --- a hobgoblin from \gls{oathtower} --- strikes the killing blow (which gives him the right to eat the entire corpse).
Other hobgoblins contest the kill (as is tradition), which prompts a bloody fight.

\basilisk

Soon after, Grawlix wins the fight and eats through the lizardy-corpse while surrounding goblins try to steal bits of meat (as is tradition).
...
By the end, Grawlix is reborn as \pgls{ogre} and stomps back with a stomach bloated with meat, to sleep an enchanted sleep in \pgls{sepulchre}.
