...
{Daisy Chains}% NAME
{\gls{juliet} makes a daisy chain, and thinks of contacting \gls{romeo}}% SUMMARY
...
{Proxy Chains}% NAME
{\Glsfmttext{MindElder} tells \gls{romeo}, `there is no love without an oath'}% SUMMARY
...
{\gls{juliet} says, `stop that snail!'}% SUMMARY
...
{Wherefore}% NAME
{A dozen goblins hunt for \gls{romeo}}% SUMMARY
