\sidequest[plateauGardens,Ravencops,Oathtower,Causeway]{Oathless Lovers}
...
{Daisy Chains}% NAME
{Juliet makes a daisy chain, and thinks of contacting Romeo}% SUMMARY
...
{Proxy Chains}% NAME
{MindElder tells Romeo, `there is no love without an oath'}% SUMMARY
...
{Juliet says, `stop that snail!'}% SUMMARY
...
{Wherefore}% NAME
{A dozen goblins hunt for Romeo}% SUMMARY
