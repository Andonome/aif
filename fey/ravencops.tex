...
\begin{boxtext}[Do you make any adjustments?]
...
\footnote{\Gls{MindElder} has taken to twisting the `minds' of snails to make them crave flesh.
They regularly consume entire \glspl{crawler} with their acidic spray, as the \glspl{crawler} has no instinct to avoid them.
This keep the \gls{crawler} population low, which keeps the goblin population low.}
...
\begin{boxtext}[]
  ...
  A long nose points up, just above the top of the potato, and milk-white ears flop at shoulder-length.
\end{boxtext}
...
If the goblin (Abjad) sees the troupe, he switches the potato to a one-arm hold and points accusingly at the troupe, then speaks in an unusually deep voice.
...
\begin{boxtext}
  Past lilac trees, an arrow's flight away, a mossy tower stands as tall as a feasting hall turned on its end.
