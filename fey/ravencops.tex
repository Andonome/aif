...
\iftoggle{verbose}{
  ...
  The map had only five locations, but every time the \glspl{pc} move, another \gls{segment} in the story places another location on the map.
