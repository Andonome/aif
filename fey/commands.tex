...
\newcommand\enchantedMapExample[1][b]{
  \renewcommand\csComments{
    \draw[thick, dashed, black] (3.6,1.1)
    ...
    -- (11,3) node[anchor=north]{\outline{Are we lost?}}
    ...
    -- (8,5.5) node[anchor=north]{\outline{Hi, \Glsfmttext{LifeElder}}}
    ;
  }
...
\newcommand\enchantedMap[1][b]{
  \renewcommand\csComments{
    ...
    \mapCircle[15]{65}{50}{2.8}{shadows/ravencops}
    \mapCircle[8]{47}{80}{2}{shadows/sunway}
...
\newcommand\enchantedMapSmall[1][t]{
  \mapNotes{
    \N\N\N\N\N\N\N\N\N/30/98,
    OOOOOOOOOO/30/92,
    \R\R\R\R\R\R\R\R/30/86,
  }
