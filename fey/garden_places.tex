\sidequest[Gardens,Canals,Ravencops,Oathtower,Causeway]{The Enchanted Land}

Each \gls{segment} of this \gls{sq} shows an area within the garden plateaus, and the \gls{sq} `continues' as long as the troupe remain in the \gls{area}.
