...
{\glsentrysymbol{morning}~Elven songs descend from the plateau above}% SUMMARY
...
{\glsentrysymbol{day}~The aurochs are returning\ldots slowly}% SUMMARY
...
\sqpart[\glsentrysymbol{evening}]{sunway}% AREA
