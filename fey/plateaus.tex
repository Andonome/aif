...
\sidequest[shadepaths,plateauGardens]{The Tao Mistress}
...
As the \glspl{pc} arrive, they take very small interest, answer questions with more questions, and then argue both sides of the answer.

To avoid vexing the players (while still vexing the \glspl{pc}) you might want to abstract this process with a \roll{Wits}{Empathy} (\tn[9]).
A tie results in one proper answer, and each Margin grants another.
