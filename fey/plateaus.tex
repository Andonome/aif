\section{\glsfmtname{plateauGardens}}
...
They take a brief interest in the \glspl{pc}, then return to their conversation.
...
The conversation switches back to Elvish soon, as the elves have little
interest in what `firyar' want to say or ask.  However, each new group of elves
the troupe encounter should allow them another opportunity (and another roll)
to engage the elves, receive answers, and pass on information.
...
{Misty Way}% NAME
{The troupe must co\"ordinate by sound and deduction}% SUMMARY
