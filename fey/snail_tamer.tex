\thread[shadepaths,plateauGardens,sunway,oathtower]{The Snail Tamer}
...
\footnote{\Gls{LifeElder} was bound by the \gls{talisman} from \vpageref{urgentLetter}, or (if the \glspl{pc} stopped its delivery) one just like it.}
...
\segment[\gls{afternoon}]{oathtower}% AREA
