...
Despite being a verdant forest, it feels bleak.

The \gls{region} lacks mana, making the air feel thin.
Unless \pgls{witch} is missing 6~\glspl{mp} or more, they can only receive 2~\glspl{mp} at the end of \pgls{interval}.
\Gls{oathtower} sucks up most of the \glspl{mp} in the surrounding \gls{region}.
