...
\histEvent{20}{2}{%
  ...
  Trials include service in the Oathtower, hunting dangerous creatures, and plenty of duels (which really helps reduce the population).
...
{\gls{romeo} should be working, but needs to complete the perfect poem}% SUMMARY
...
\sqpart{Sunway}% AREA
{The Elven Way}% NAME
{Hidden stairs lead to \pgls{plateauGardens} above}% SUMMARY
