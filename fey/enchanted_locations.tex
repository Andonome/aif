\thread[ravencops]{Locations in \glsfmttext{enchantedLands}}
...
\begin{boxtext}
  Twenty \glspl{step} ahead, across a buzzing meadow, a tree glows in the dark, lit from somewhere below.
  There are no signs of a fire nearby.
  Just darkness, three boulders lit by feint starlight, and distant trees.
\end{boxtext}
...
\begin{exampletext}
  \Gls{MindElder} ordered this \gls{sepulchre} made before he understood how easily \glspl{ogre}' dreams shatter.
\end{exampletext}

These three \glspl{ogre} snore quietly.
Unlike the other \glspl{sepulchre}, no footprints form a path, as the goblins have mostly forgotten about them.
...
\begin{boxtext}
  ...
  A little goblin sleeps in a hammock under the gentle-green glow of \pgls{glowshroom}, muttering in his sleep.
