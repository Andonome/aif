...
{The \glsentrytext{ranger} arrives to scope out the situation}% SUMMARY
...
{The ranger explains his plan to kill \glsentrytext{LifeElder}}% SUMMARY
...
\sqpart{sunway}% AREA
{Wandering Hood}% NAME
{The \glsentrytext{ranger}'s clothes lie discarded on the ground}% SUMMARY
