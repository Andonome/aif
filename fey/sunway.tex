...
\subsection{\glsfmtname{plateauGardens} Walls}
...
they roll \roll{Speed}{Athletics}, and the \gls{tn} equals $1D6 +$ their Strength Bonus, plus the \gls{weight} of items carried.
Failure breaks the branch (or root, or vine) and they tumble down, and hit the ground four \glspl{step} below, while earth or plants dislodge and falls on them after the fall.
\label{climbingWalls}
