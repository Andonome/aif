...
\Gls{MindElder} sends goblins to wake \pgls{sepulchre} of \glspl{ogre} with a meagre breakfast, and pass along the order to run at full pace towards \gls{sunway}, and stop the ritual by screaching, tearing down trees, and `confiscating' `items of ritual abuse' (\glspl{boon}).
