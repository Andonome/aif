...
\begin{itemize}
  ...
  Soldiers spend most of their time in civilized places, but every so often, a Lieutenant will summon dozens to gather for some excursion beyond \gls{edge}.
...
A prefect simply stipulates what funds they require from the \gls{guard}, or \gls{shatteredcastle}, and (if they are feeling polite) why.
