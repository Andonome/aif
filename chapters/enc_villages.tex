...
\epigraph{A rock is a good thing, too, you know. If the Isles of Earthsea were all made of diamond, we'd lead a hard life here. Enjoy the illusions, lad, and let the rocks be rocks.}{Ursula Le Guin}
...
\villages{You See a Deer}{A human has been transformed into a deer, and simply stops to stare at the characters}
\stopcontents[forest]
...
\forest{The Green Tower}{The party find people setting up a base of operations in the forest}
...
\town{Rogue Sheep}{The party find a person turned into a sheep}
...
\town{\glsentrytext{forestpriest} Exiled}{The town crier announces that \glsentrytext{forestpriest} is a wanted criminal}
...
\villages{The Crow}{A recently fallen corpse is raised from the dead by a bird with a magical amulet}
...
\forest{The Undead Hord}{A great load of ghouls have become lost and now wander the forest}
...
\villages{The Survivors}{A village has been raided, and only followers of Qualm\"{e} have been spared}
...
\villages{Knight of the Dead}{The necromancer makes a full-on assault on a village}
...
\villages{Fallen Traders}{A number of traders have fallen to bandits}
...
\villages{Hidden Eyes}{Bandits watch the characters from the side of the road silently}
...
\villages{The Feast is Cancelled}{The Immortal Bandits have raided a village during a wedding}
...
\villages{The Dead Tracker}{A member of the Night Guard sent to track down where the dead have come from has returned as a ghoul}
...
\villages{The Showdown}{The bandits have finally decided to confront the characters}
...
\town{Bandits Caught}{The bandits who plagued the countryside have been imprisoned}
...
\villages{Your Money or Please Don't Hurt Me}{Villagers from Redfall are so hungry they have turned to banditry, but they're not very good at it}
...
\villages{Wrong Direction Chickens}{A tradesman is taking chickens \emph{from} town}
...
\town{The Nonstarter}{\Glsentrytext{nurabaron}'s diplomat asks the party to help him}
...
\town{The Town Crier}{\Glsentrytext{nurabaron} has been found out, and everyone in town wants the bounty on his head}
...
%
%\villages{The Dead Courier}{The party find a dead courier on the road with a message}
%
%\begin{boxtext}
