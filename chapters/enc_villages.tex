...
\gls{duke} wants to expand his domain into a nearby forest, but \gls{forestpriest} has other plans.
...
\begin{enumerate}
	...
	\item{The bandits pick just the right time to attack the characters.}
	\item{The bandits have been apprehended in town}
\end{enumerate}
...
Centuries ago, men created a logging city, and the elves destroyed it.  Recently, \gls{duke} has decided to reclaim it, though nobody knows exactly where it is.  He sent a dozen trackers to find the place in the hopes of rebuilding it; but \gls{forestpriest}, doesn't like the situation, and has been turning anyone who finds or hunts for the place, into animals.
...
Deep in the forest, \gls{duke} has commissioned masons to start building a single tower from the fallen stone of \gls{lostcity}. This is the first forway into the deep wilderness.  The top is to be disguised by painting is green (the color is made by malachite, which can be expensive).
...
Yesterday, \gls{duke} and a number of his men met to discuss further building inside the deep forest, and hunting for \gls{lostcity}.
