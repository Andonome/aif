...
Deep in the forest, \gls{townmaster} has commissioned masons to start building a single tower from the fallen stone of \gls{lostcity}.
This is the first forway into the deep wilderness.
The top is to be disguised by painting is green (the color is made by malachite, which can be expensive).
...
\sqpart{Villages}{\N Your Money or Please Don't Hurt Me}{Villagers from Redfall are so hungry they have turned to banditry, but they're not very good at it}
