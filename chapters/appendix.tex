...
\chapter{A Creation Tale}\index{Creation Tale}
...
The Rise of Rex Dalius Quennome\label{h_dalius}\index{Dalius Quennome}
...
\index{Rex Hunter}\index{The War of Portals}
\begin{quotation}
...
From the Journals of Gregor Dogland\index{Gregor Dogland}
...
% maybe remove all this - it's kinda done above already
