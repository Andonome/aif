These random side quests should work with any area which contains woodpies and chitincrawlers, such as Mt Arthur, Dogland, or Quennome.  See page \pageref{sidequests} for how to run them.  If your area doesn't contain those creatures, just remove those encounters which features them.
