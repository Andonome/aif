...
\begin{boxtext}
	...
	You turn to see an insectoid creature, bigger than any war horse and covered in thick, black armour, racing to eat the slowest member of the party.
...
\begin{boxtext}
	...
	It sounds like there could be ten of them, but it's hard to tell with all the ehoing.
...
\paragraph{Tactics:} Dwarven  warriors typically adopt the Agggressive Stance and trust to their plate armour to keep them safe in battle.
...
\begin{boxtext}
	...
	The leaves all around seem to sway and feintly grow in response to the song.
...
Travelling elves are usually less snobbish and are better at immitating human customs such as wearing clothing.
...
Some few can be bargianed with, but it's famously difficult to bargain with creatures who don't have any use for gold, outside information, or friends.

\paragraph{Tactics:}
Dryads always have a penalty of 5 MP to keep their dryad form in place, though some remove it to revert to elf-form or cange into a human.
...
\begin{boxtext}
	...
	``Ok'', he concedes, ``I'll show you the jewels I stole if you don't hurt me''.
...
\best{Gnomish Illusionist}\index{Illusionist}
...
If encountered before that time, they stalk.
Most of their prey are tired by the end of the day.
...
\paragraph{Society:} Hobgoblin tribes never last too long.
Like all Nura, they must eat more than any land can sustain.
One or two hobgoblins released from a cavern, transformed into twisted creatures, might wreak a little havoc before being put down.
But if they manage to capture a village and guard it for long enough to quickly raise children, whole armies can be created before long, and a hobgoblin infection rears its head, numbering anything from tens to thousands of hobgoblins.
Generally speaking, each full farm will provide enough food to quickly raise ten hobgoblins to adulthood, since they take only a single cycle (four seasons) to grow up.
This incredible rate of growth is part of what requires so much food.
