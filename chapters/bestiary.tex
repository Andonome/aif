...
Gnoll shamans typically follow Laiqu"{e} or Qualme.  They are a rarity in any gnoll society but always accorded respect when they are present.  They are not permitted to enter war councils but are also immune to all challenges except from other shamans.
...
\label{human_soldier}
\subsubsection{Bandits and Soldiers}\index{Soldier}\index{Bandit}
\humansoldier
