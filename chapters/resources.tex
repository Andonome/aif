...
However, if five characters are fighting the 10 zombies together, they each deduct 5 XP from a single monster.  The first five zombies are worth nothing, because each net ($2 - 5 = $) 0 XP.  Only the last 5 zombies count, bringing 10 XP in total.
