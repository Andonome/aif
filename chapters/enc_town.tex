...
\epigraph{A good person? Well\ldots I don't really like that term. Because to me, it just seems to mean someone who's good for you. And I don't think there's any one person who's good for everyone.}{Armin Arlert}
...
\town{Pickpocketed}{Someone has stolen one of the characters' items}
...
\town{The Captain}{\Glsentrytext{captain} jumps into another encounter to help the party}
...
\town{The Riddle}{\Glsentrytext{college} have raised a bounty on a riddle}
...
\town{Illegal Songs}{A bard is caught singing about how much better it was before the current ruler, \Glsentrytext{king}}
...
\town{Pickpocketed Again!}{Someone else picks a character's pocket}
...
\town{Streetbrawl}{The local alcoholics are on the street, and fights are breaking out}
...
\town{The Shell Game}{The characters must take a fake magical item to the Night Guard so it can be swapped for the real one}
...
\npc{\G}{Ten of the Woodspy Bandits}
...
\town{Rumours of Magic}{\Glsentrytext{townmaster} hires a local thief to steal a book to learn of the item's command word}
...
\villages{More Rumours of Magic}{Local villagers think they have figured out the command word for the ammulet}
...
\town{The Mob}{The amulet is dropped, and the townsfolk all clambour after it}
...
\town{They Took Our Jobs!}{Novice cutthroats assault the characters, but they have no idea what they're doing.}
...
\villages{The Old Lady}{A little peasant girl wears fantastic wealth because the amulet has been found by a village woman who uses it to summon gold}
...
\villages{Martha Returns}{The old woman who has the item appears to help the characters}
...
\town{The Drunken Knight}{A knight of the local Ale Guild starts fights while pretending to be from the Ale Guild of the Bearded Mountains}
...
\town{Ale Explosion}{Barrels of Ale explode down the street}
...
\town{You Can't Drink Here}{Envoys of the Ale Guild from the bearded mountains are refused entry to a tavern, and a fight breaks out}
...
\town{We're Dry}{The town has completely run out of ale as supplies from the Bearded Mountains have run out}
...
\town{Bad Water}{The town's main spring smells disgusting}
...
Play this encounter at the same time as the one below.
\town{The Nura Child}{A street urchin transforms into a nura creature}
...
\town{Unexpected Ghouls}{Hobgoblin ghouls from below emerge and attack the town}
...
\town{Underground Assassins}{The bandits in the sewer cut \Glsentrytext{townmaster}'s throat}
...
\town{The Nura Rise}{The hordes underneath begin to spill above ground}
...
\includesvg{images/Dyson_Logos/white_horse_2.svg}
\setcounter{list}{0}
...
\sidepic[5]{Dyson_Logos/white_horse_1.svg}
...
\npc{\G\M}{\Glsentrytext{townmaster}'s Nine Sons}
...
\noindent\includesvg[width=\linewidth]{images/Dyson_Logos/guard_station.svg}
...
\noindent\includesvg[width=\linewidth]{images/Dyson_Logos/under_station.svg}
