...
\sqpart{Town}{Rumours of Magic}{\Glsentrytext{townmaster} hires a local thief to steal a book to learn of the item's command word}
...
\sqpart{Villages}{More Rumours of Magic}{Local villagers think they have figured out the command word for the ammulet}
...
\sqpart{Town}{The Mob}{The amulet is dropped, and the townsfolk all clambour after it}
...
\sqpart{Town}{We're Dry}{The town has completely run out of ale as supplies from the Bearded Mountains have run out}
...
\sqpart{Town}{Bad Water}{The town's main spring smells disgusting}
...
\sqpart{Town}{The Nura Child}{A street urchin transforms into a nura creature}
...
\sqpart{Town}{Streetbrawl}{The local alcoholics are on the street, and fights are breaking out}
...
\sqpart{Town}{Unexpected Ghouls}{Hobgoblin ghouls from below emerge and attack the town}
...
\sqpart{Town}{Underground Assassins}{The bandits in the sewer cut \Glsentrytext{townmaster}'s throat}
...
\sqpart{Town}{The Nura Rise}{The hordes underneath begin to spill above ground}
