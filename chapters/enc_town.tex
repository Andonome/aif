...
\sidequest{The Lizardite Amulet}

A magical item either holds extreme power, or possibly danger; nobody knows.
Page \pageref{lizardite}.

\magicitem{The Lizardite Amulet}{Conjuration 5}{Alchemy}{4 Scenes}{Potent, Greater Magical Item}{6}{30}

\begin{enumerate}

	\item{The characters must warn a group they are under attack, and take a replica to them, but attack the characters instead.}
	\item{A thief steals a book detailing the item's power-word.}
	\item{(Villages) A rumour spreads that the item's command-word is ``Myriad Fishes''.}
...
Bandits hiding in the sewer are amassing an army of the dead.
Page \pageref{sewerbandits}.

\begin{enumerate}

	\item{\ding{106} Water around the town goes foul.}
	\item{\ding{106} Ghouls appear suddenly in town.}
	\item{\ding{106} Thieves stab \gls{duke}, then jump underground to hide.  Mass panic ensues.}
...
\Gls{sewerthief}, delivering goods on behalf of \gls{duke}, was pickpocketed by a street-child.  The child had pilfered food, enchanted to turn whoever ate it into a nura monster.
...
\Gls{duke} hired Derek, a local thief, to steal the Book of Ancient Wars, detailing various battles about the time of time of Rex Dalius.\footnote{See page \pageref{h_dalius} for more.}
...
If questioned at any point, \gls{duke} will have plenty of excuses, and in the end be given a library fine of 3cp.
...
\gls{duke} recently asked a number of guards about recent nura sightings, and why there was suspicious activity in town, such as the strange Whitelander accent heard in \gls{pig}.
...
If the characters run to help the wounded man, they find \gls{duke} with a knife-wound, next to his wife. The roll is Wits + Medicine, at TN 9.
...
If \gls{duke} survives, he has little idea of what's happening, although an Intelligence + Vigilance roll (TN 10) could reveal what he's been asking about recently.
...
The man at the back door is Peter -- one of the local Whiteland nobles. He's had to take to theft and occasionally spies on people to survive, like so many other dispossessed nobles.  Nobody can know that he lives below -- he just came by to grab a meal before heading back out to become a labourer for \gls{duke} so the underground bandits can keep an eye on what he's doing.
