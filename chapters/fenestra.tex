...
\begin{encounters}{Eastlake}
	...
	\li & A contingent of zombies (page \pageref{zombie}). \\
\li \lii An undead knight (page \pageref{undead_knight}). \\
	\li \lii Wolves (page \pageref{wolf}). \\
	& \lii A bear (page \pageref{bear}). \\
