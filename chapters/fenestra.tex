...
\begin{encounters}{the Bearded Mountains}
	...
	\li &  $2D6$ Dwarvish bandits (Page \pageref{dwarven_solder}). \\
...
Upon the coast, a second branch of the College of Alchemy has opened at the coast, devoted entirely to martial magic.
The King has allowed the alchemists to operate fairly independently, and with a lot of funding, in order to gather information on any potential attacks upon the Pebbles islands, nearby.
...
King Wyatt, worried about the possibility of creating a ruling class of powerful alchemists, has banned all alchemists from owning land.
...
An empty wasteland sits between the elvish forests and the dwarvish mountains to the South in the Bearded Mountains region.
...
\begin{encounters}{Mt Arthur}
	...
	\li & Mana Lake (page \pageref{mana_lake}). \\
	\li & Basilisks (page \pageref{basilisk}). \\
