...
\printcontents[forest]{l}{2}{\section*{Summaries}\setcounter{tocdepth}{3}}
...
\forest{Just Move Along}{A chitincrawler tries to dig up a little gnome}
...
\forest{Weather}{Seasonally appropriate weather strikes}
...
\forest{Random Traders}{Three tradesmen are lost in the forest}
...
\forest{The Elven Party}{The party are told to dance, and dance they must}
...
\NPC{\M}{Taurestel}{Pedagogue}{``For example\ldots''}
...
\forest{Furry Traders}{Three gnolls are here to trade}
...
\forest{The Mouth of Hell}{A thousand woodspies have gathered around a hole which spits goblins}
...
\forest{No, Wait, Yes, Um, Wait, No\ldots}{The spiderqueen casts illusions of chitincrawlers, while sending real chitincrawlers after the party}\label{spiderqueenssong}
...
\villages{Sheep Stampede}{\Glsentrytext{spiderqueen} summons sheep to be eaten by her chitincrawlers}
...
\villages{Quiet Little Hamlet}{An entire hamlet has been eaten by chitincrawlers}
...
\forest{The Lone Ranger}{A member of the Night Guard stalks \glsentrytext{spiderqueen}}
...
\NPC{\M}{Gregory of the Night Guard}{Suspicious}{Purses lips}

\humansoldier

\forest{I Have a Cunning Plan}{Three gnomes have an elaborate plan to catch \glsentrytext{spiderqueen}}
...
\forest{Help}{An elven prince needs help}
...
\forest{Karma}{Three elves return to repay the characters for their previous actions}
...
\NPC{\E}{Sindon}{Lively}{Strokes hair}
...
\sidepic[7]{Dyson_Logos/under_lost_city.svg}
