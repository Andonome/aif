...
\sqpart{Forest}{The Mouth of Hell}{A thousand woodspies have gathered around a hole which spits goblins}
...
\sqpart{Forest}{The Arachnid Doublecross}{The spiderqueen casts illusions of chitincrawlers, while sending real chitincrawlers after the party}\label{spiderqueenssong}
...
\sqpart{Forest}{I Have a Cunning Plan}{Three gnomes have an elaborate plan to catch \glsentrytext{spiderqueen}}
...
\sqpart{Forest}{Help}{An elven prince needs help}
...
\NPC{\M}{Sindon}{Lively}{Strokes hair}
...
\NPC{\M}{Neuror}{Jovial}{Spits}\label{neuror}
