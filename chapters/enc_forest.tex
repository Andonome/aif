...
\begin{enumerate}
	...
	\item{(Forest) A lone soldier is tracking \gls{spiderqueen}.}
...
Resting slightly above ground, the first floor contains one lavish room, which nobody is allowed to enter.  It's left in preparation for the arrival of \gls{duke}.
