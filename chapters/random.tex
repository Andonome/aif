...
\begin{list}{\addtocounter{list}{1}\textbf{\arabic{list}:}}{\raggedleft}
	...
	%\item{ A prophecy from a high priest of Ohta decreed that you were fated for great things.  You might not follow this god -- you may not even approve of Her.  It matters not a bit to the church how you feel, all they demand is that you carry their sacred weapon.  It is a sword which can summon a random animal to your side, as per the second level of the conjuration sphere.  If it is ever taken from you, the sword teleports back to your hand as soon as it has a sufficient amount of mana.  It holds 4 MP at maximum and regenerates 2 per scene.  It counts as having an Intelligence bonus of 3.  This sword also grants you a 4 bonus to all social tasks involving those who follow Ohta as it is famous among her scriptures.  You are required to give the sword a name, just as those who used it to fight against the encroaching nura during the nura wars each gave it a name.  The conjuration of animals requires 2 MP while teleportation requires 4 MP from the sword's total. }
...
\item{Everyone gets teased during childhood but yours was beyond severe.  The constant taunts have taught you a thing or two however -- you begin play with the Knack: Fox Hop.}
...
\item{There is a prophecy that you will somehow interfere with the will of Qualme -- you have no idea what this is about but some cult or other out there are not happy with you.  Someone has sent an undead knight to kill you.  It instinctively knows roughly where you are.  It follows you on foot. You keep moving, on horseback (begin play with a horse) whenever you can, every day.  You are safe only in populated areas, where it usually does not approach.  See page \pageref{undead_knight}.}
