...
\begin{exampletext}
	...
	The clever setup started by making an alchemical portal from the Rex's castle in the Shale to a hidden location; we've already passed through it in one of those corridors, so we have already entered Whiteland.
