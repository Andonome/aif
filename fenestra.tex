...
\iftoggle{players}{
  ...
  \subsection{Encounters}
  Mt Arthur has sprawling, quiet, villages, but fierce forests.
...
\iftoggle{players}{
  ...
  \paragraph{Shale's areas work a little differently from other regions.}
...
\iftoggle{players}{
  ...
  \textbf{5} & 2 encounters on the same day \\
  \textbf{5} & 1 encounter \\
  \textbf{4} & 6 days peace \\
  \textbf{3} & 4 days peace \\
  \textbf{2} & 3 days peace \\
  \textbf{1} & 1 day of peace \\
  \end{rollchart}
