...
\noindent
Left to their own devices, humans populations will explode until they run against the buffer of limited resources.
There are three ways for a human population to limit their numbers -- war, disease and famine.
Well, there were three ways in our own history.
In Fenestra, the natural population boundary is the creatures, as humans, dwarves, elves, and others are the natural prey of a world of hungry creatures..

\subsection{The Primordial Forest}

The world of Fenestra \emph{older} then ours.
...
However, the forests are also bursting with fruits, nuts, and all manner of food, so the dispossessed come.
...
Most of the villages here are walled.
...
In these outer regions, by the forests, travelling by road is still dangerous, as creatures lie in wait for anyone in a sufficiently small group.
Few people leave the village in groups of less then ten, unless travelling by water, and even then, many predators can swim.
...
Moving farther inwards, villages become more peaceful as they get closer to a town, and have the luxury of other villages nearby.
...
\Gls{king} protects his monopoly on the portals fiercely, by making all other portals illegal.
The royal stance upon portals is that they have caused problems in the past, and are too dangerous to go uncontrolled.
...
\noindent Fenestra contains seven regions, each of which have a slightly different ecology and different populations.
...
\paragraph{Cold} seasons above ground become perishingly cold, inflicting an additional 4 Fatigue points per day of travel.
