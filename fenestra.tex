...
\iftoggle{players}{}{
  ...
  \hline
  \hline
  \textbf{8} & Villagers & Alchemists practising Invocation & Lightning Storm & Earthquake & Hurricane & Ghast & 6 Ghouls  & Deer \\
  \hline
  \textbf{7} & Flood & Woodspies & Heavy mist & Rain & Mouthdigger & 2 Ghasts & Bear & Demilich \\
  \hline
  \textbf{6} & 12 \glspl{guard} & 6 \glspl{guard} & Rain & Heavy Hail & Woodspy & 6 Snow Elves & Auroch stampede & 10 Ghouls \\
  \textbf{5} & Noble Caravan & Fisherman & 10 Bandits & 8 Wolves & Lightning Storm & Gnolls & Deer & Mana Lake with $1D6$ practising alchemists \\
  \textbf{4} & Villager Funeral & Bow Sellers & Biting Wind & Bear & Wolves & Snow Elf disguised as a human & 8 Ghouls & 4 Griffins \\
  \textbf{3} & Paper Guild Caravan & 20 \glspl{guard} & 4 Brigands & 4 Refugees from Fallen Village & Snowstorm & 8 Brigands & Dryad eating brigands & Gnoll Hunters \\
  \hline
  \textbf{2} & Vegetable Traders & Pilgrims & Breeze & 10 Bandits & Griffin & Apprentice alchemists up to no good & Boar & Wild Horses \\
  \hline
  \textbf{1} & Villager Wedding & Dwarves & 4 Gnoll Dog Sellers & Snow Elves riding griffins above & 7 Bandits & 8 Gnomish Crossbow Traders & Griffin & Grazing Aurochs \\
  \hline
  \textbf{0} & Begging Villagers & Snowstorm (roads closed) & Lakes and Rivers Freeze & Heavy Hail & 4 Hungry Wolves & Snowstorm & Mist & Deer \\
  \end{nametable}
  \end{figure*}
}
...
\iftoggle{players}{}{
  ...
  \hline
  \hline
  \textbf{8} & Villagers celebrating a local festival & Swamp & Lightning Storm & Earthquake & Hurricane & Mouthdigger & Woodspies mating & Forest Fire \\
  \hline
  \textbf{7} & Flood & Heatwave & High Humidity & Rain & Basilisk & Woodspy & Chitincrawler & Basilisk \\
  \hline
  \textbf{6} & \glspl{guard} & \glspl{guard} & Woodspy & Gnoll Raiders & Rain & Bear & Woodspy & Dragon \\
  \hline
  \textbf{5} & Noble Caravan & Rain & Bandits & Wolves & Lightning Storm & Chitincrawler & Deer & Mana Lake \\
  \textbf{4} & Villager Funeral & Sword Guild Nomads selling weapons & Storm & Bear & Wolves & Mouthdigger & Basilisk & Basilisk \\
  \textbf{3} & Villagers selling meat & \glspl{guard} & \gls{guard} Scouts & Refugees from destroyed village & Brigands & Gnoll Raiders & Gnoll Raiders & Aurochs \\
  \hline
  \textbf{2} & Pilgrims & Alchemist with entourage & Gnoll Guild Slavers with captives  & Bandits & Mouthdigger & Griffins & Boar & Griffin \\
  \hline
  \textbf{1} & Bard & Dwarven Traders & Gnoll Guild Slavers with captives & Griffin & Bandits & Gnomes & Griffins & Aurochs \\
  \hline
  \textbf{0} & Begging Villagers & Bandits & Snowfall & Hail & Hungry Wolves & Gnoll Raiders & Boar & Hibernating Chitincrawlers \\
  \end{nametable}
  \end{figure*}
}
...
\iftoggle{players}{}{
  ...
  \hline
  \hline
  \textbf{8} & Villagers celebrating a local festival & Sulphur Winds & Lightning Storm & Earthquake & Hurricane & Mouthdigger & Woodspies mating & Forest Fire \\
  \hline
  \textbf{7} & Flood & Heatwave & Ooze & Rain & Chitincrawler & Woodspy & Chitincrawler Eggsack & Basilisk \\
  \hline
  \textbf{6} & Noble Caravan & \glspl{guard} & Woodspy & Elves & Rain & Bear & Woodspy & Chitincrawler \\
  \hline
  \textbf{5} & \glspl{guard} & Ale Guild Nomads selling flour & Bandits & Wolves & Lightning Storm & Chitincrawler & Deer & Mana Lake \\
  \textbf{4} & Villager Funeral & Paper Guild Nomads selling books & Wind & Bear & Wolves & Mouthdigger & Basilisk & Basilisk \\
  \textbf{3} & Villagers selling wool & \glspl{guard} & \gls{guard} Scouts & Refugees from destroyed village & Brigands & Gnolls & Brigands & Elves \\
  \hline
  \textbf{2} & Pilgrims & Priest of Laique & Breeze & Bandits & Mouthdigger & Griffins & Boar & Griffin \\
  \hline
  \textbf{1} & Bard & Escaped Gnoll Slaves & Sword Guild Nomads & Griffin & Bandits & Griffins & Deer & Aurochs \\
  \hline
  \textbf{0} & Begging Villagers & Bandits & Snowfall & Hail & Hungry Wolves & Snowstorm & Boar & Hibernating Chitincrawlers \\
  \end{nametable}
  \end{figure*}
}
...
\iftoggle{players}{}{
  ...
  \textbf{7} & Flood & Heatwave & Ooze & Rain & Chitincrawler & Woodspy & Chitincrawler Eggsack & Basilisk \\
  \hline
  \textbf{6} & Noble Caravan & \glspl{guard} & Woodspy & Elvish Enchanter & Rain & Bear & Woodspy & Chitincrawler \\
  \hline
  \textbf{5} & \glspl{guard} & Ale Guild Nomads selling flour & Bandits & Wolves & Lightning Storm & Chitincrawler & Deer & Mana Lake \\
  \textbf{4} & Villager Funeral & Armed Paper Guild Nomads mapping the area & Storm & Bear & Snake bite! & Mouthdigger & Basilisk & Basilisk \\
  \textbf{3} & Villagers selling fish & \glspl{guard} & \gls{guard} Scouts & Refugees from destroyed village & Brigands & Gnolls & Brigands & Elves \\
  \hline
  \textbf{2} & Pilgrims & Priest of Laique & Breeze & Bandits & Mouthdigger & Boar & Griffins & Griffin \\
  \hline
  \textbf{1} & Bard & Long Barge passing & Sword Guild Nomads & Griffin & Bandits & Griffins & Deer & Aurochs \\
  \hline
  \textbf{0} & Begging Villagers & Bandits & Snowfall & Hail & Hungry Wolves & Snowstorm & Boar & Hibernating Chitincrawlers \\
  \end{nametable}
  \end{figure*}
...
\iftoggle{players}{}{
  ...
  \hline
  \hline
  \textbf{8} & Mouthdigger  & Sulphur Winds & Earthquake & Ground cracks: everyone falls! & Earthquake & Gas Leak & Earth cracks, new passage opens\ldots \\
  \hline
  \textbf{7} & Basilisk & Heatwave & High Humidity & Flood & Gnomes & Ooze & Goblins \\
  \hline
  \textbf{6} & Chitincrawler & \glspl{guard} Scouts & Noble Caravan & Elves & Fungal Garden & Dwarven Soldiers & Umber Hulk \\
  \hline
  \textbf{5} & \glspl{guard} & \Dw\ Sword Guild \Glspl{nomad} selling armour & Wolves & Bandits & Bandits & Crumbling cavern & Hobgoblins \\
  \textbf{4} & Griffin & Storm & Paper Guild \Glspl{nomad} selling books & Bear & Ooze & Umber Hulk & Mana Lake \\
  \textbf{3} & Woodspy & \glspl{guard} & \gls{guard} Scouts & Gnomish traders & Brigands & Watcher & Hobgoblins \\
  \hline
  \textbf{2} & Mouthdigger & Paper Guild caravan & Brigands & Bandits & Mouthdigger & Umber Hulk & Hobgoblins \\
  \hline
  \textbf{1} & Brigands & Wolves & Sword Guild Traders & Bandits & Ooze & Ooze & Goblins \\
  \hline
  \textbf{0} & Hibernating chitincrawler & Snowfall & Bandits & Woodspy & Ooze & Dwarven Traders & Umber Hulk \\
  \end{nametable}
  \end{figure*}
}
...
\iftoggle{players}{}{
  ...
  \hline
  \hline
  \textbf{8} & \Hu Villagers celebrating & Hailstorm & Lightning Storm & Earthquake & Hurricane & \Nl 1D6+5 Gnolls & Auroch Stampede  & Deer \\
  \hline
  \textbf{7} & Flood & $1D6$ Woodspies & Thick Mist & Rain & Mist & Mouthdigger & \A\ Boar & \A\ Bear \\
  \hline
  \textbf{6} & \Hu\ $1D6$~\glspl{guard} & \Dw\ $2D6$ \glspl{guard} & Rain & Heavy Hail & \E\ Woodspy & \El\ $1D6+2$ Snow Elves & Auroch stampede & \A\ $1D6$ Griffins \\
  \textbf{5} & \Hu\ \Gls{king}'s Prefect caravan (4D6 \glspl{guard}) & \Hu\ $1D6+6$ Fishermen walking home & \Hu\ $1D6+8$ Bandits & \A $1D6+4$ Wolves & Lightning Storm & \Nl\ $1D6+3$~Gnolls & \A\ Deer Heard & Mana Lake \\
  \textbf{4} & \Hu\ Villager Funeral & \Hu\ $1D6+4$~Bow Sellers & Biting Wind & \A~Bear & \A~Wolves & \El\ Snow Elf disguised as human & \D\ $3D6$~Ghouls & \A\ $1D6$ Griffins \\
  \textbf{3} & \Hu\ Villager Wedding & \Hu\ $4D6$ \glspl{guard} & \Hu\ $1D6+4$ Brigands & \Hu\ $2D6$ Refugees from Fallen Village & Snowstorm & \Hu\ $1D6+4$ Brigands & \El~Dryad & Portal to Realm of Shifting Corridors \\
  \hline
  \textbf{2} & \Hu\ Vegetable Traders & \Hu~$3D6$ Pilgrims & Biting Wind & \Hu~$1D6+8$ Bandits & \A~Griffin & \Hu~$1D6+2$ \glspl{guard} & \A~Griffin & \Nl\A~$1D6+2$ Gnoll Hunters, 1 dog each \\
  \hline
  \textbf{1} & Snow blocks road & \Dw~Sword Guild Traders & $1D6$ \Nl~Dog Sellers & \El\A\ $1D6$~Snow Elves riding Griffins above & \Hu~$1D6+8$ Bandits & \Gn~$2D6$ Crossbow Traders & \A~Boar & \A~Auroch Herd wandering \\
  \hline
  \textbf{0} & \Hu~$1D6$ Begging Villagers & Snowstorm (roads closed) & Lakes and Rivers Freeze & Heavy Hail & \A~$1D6+6$ Hungry Wolves & Snowstorm & Mist & \A~Deer \\
  \end{nametable}
  \end{figure*}
}
