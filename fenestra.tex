...
\subsection{Walking with the Night Guard}
...
\begin{exampletext}
	...
	The clever setup started by making an alchemical portal from the Rex's castle in the Bearded Mountains to a hidden location; we've already passed through it in one of those corridors, so we have already entered Whiteland.
...
\begin{exampletext}
	...
	Everyone dies a hero in the Night Guard.
	...
	Of course the towns, and even cities, have Night Guard patrolling them with good reason.
...
\begin{exampletext}
	...
	Like I said, everyone dies a hero in the Night Guard.
...
\begin{exampletext}
	...
	On other trips, the Night Guard enter first, and clear a path for people to cut timber down, make walls, lay rocks for a road, and then begin houses inside.
...
Civilization exists in small pockets of Fenestra, loosely connected via dangerous roads.
While walled cities have nothing to fear, people cannot live there without food, so most must work in fields to feed the cities where specialist workers and nobles live.
...
When a village has too many young archers die, or too many livestock stolen to feed itself properly, it can no longer defend itself, and the remaining inhabitants must flee to neighbouring villages, or into a town, where most will have to join the Night Guard.

\subsubsection{Chaos at the Edge of Civilization}

Exactly what lies in wait for people depends upon the area.
...
Different civilizations also have their own way of dealing with these things.
Elder elves can use powerful magics to make an area safe for their villages, without needing any walled towns.
Meanwhile, dwarves have their own underground creatures to worry about, and tend to have harder boundaries between their liveable areas, and the dreaded `outwall'.
