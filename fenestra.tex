...
\noindent
Throw a European peasant into Fenestra and they would call those great forests paradise.
Each one is full of fat fruits and plenty of game animals -- nobody ever needs to starve in Fenestra.
Even better -- Fenestra has few wars, and almost no disease.
Left to their own devices, humanity could flourish.

However, those beautiful forests are also full of monsters.
Here, humans are the natural prey to an abundance of predators.
...
The vegetation and animals can also grow gargantuan size.
...
Unfortunately, the regular inhabitants can't see much beauty in the forests: they only see danger.
Giant lizards belching poisonous gas, spider-like creatures with hands on each leg, and land-octopuses camouflaged over a tree; all of them roam the forest, quite prepared to hunt groups of people as easily as they do deer.

However, the forests are also bursting with fruits, nuts, and all manner of food, drawing people who would otherwise go hungry.
Whether starving, or fleeing from the law, those who have to leave build whatever fortifications they can in the forests.
Most places are so thick with tree coverage that they exist in perpetual twilight.
Even the occasional roads which stretch through the forests are dim enough to hide predators during the day.

\subsection{Villages}

The edges of civilization begin with tended forests, where trees are moulded into useful shapes for later use as bows, or farming equipment, and where the bushes are burnt or hacked away, so people can walk or hunt deer more easily.
The increased visibility also provides safety as one can often see predators coming from some distance away.

Out here, the Night Guard patrol, destroy foliage, and occasionally hunt the creatures which come out of the forest.
Nobody wants to join the Night Guard, but it's a better choice than banditry, so the excess people that society produces are pushed into the Guard.

Most of the villages here are walled, and many are built on islands, near caves, or otherwise in easily defended positions.
Others organize archers inside, so that any creatures which emerge can at least be chased off.
Herds of animals kept here need constant tending, as the creatures in the forest are always tempted by the cries of cows, sheep, and goats.

Many villages also erect tall walls.
These have limited use against monsters that can climb, but at least serve to slow them down before they escape with an animal, giving local archers time to shoot down the creature.
If such places survive, they generally have some nearby fortification to run to in case things get \emph{really} bad, often with just enough to get the town and some of their flock inside.

Such fortifications are owned by `village masters' -- a title similar to a baron, but with more expectations of immediate aid to the locals if problems arise.
The village master is officially there to organize a fighting militia, and ensure the safety of the people, and their animals.

Travelling by between villages kills people regularly, as creatures lie in wait for anyone in a sufficiently small group.
Few people leave the village in groups of less then ten.
Boats afford more safety than travelling on foot, but the water still teems with hungry life.
...
Moving farther inwards towards the town, villages become more peaceful and feel less need for walls.

\subsection{The Towns}

Towns, and rare cities, provide near-complete protection from the predators which roam outside.
However, the price is a serious lack of food, and many starve to death rather than facing the creatures outside.

\subsubsection{Guilds \& Temples}
...
The \Gls{shatteredcastle} surrounds and joins Fenestra.
Reaching the greatest city of Mount Arthur, a single wing can be seen.
It may \emph{look} like an entire castle from outside, but it is only one wing.

With a nod from the guards and the proper payment, you are allowed into the trader's route, and travel into a long, freezing, tunnel.
The tunnel houses a magical portal, but nobody knows at exactly which point the magical portal lies; all we know is that at some point, you step out of Mount Arthur, and into Whiteland.

Nobody knows where in Whiteland the heart of \gls{shatteredcastle} rests, but everyone knows that once inside, there are other magical portals, leading to other wings of \gls{shatteredcastle}.
One portal goes to the Bearded Mountains, where \gls{king}'s armies can keep an eye on the rebellious dwarves.
Another leads to the Pebbles, where \gls{king} spends most of his time, living in safety on his secluded island.

Six of the seven lands in Fenestra hold a single wing of \gls{shatteredcastle}.
\Gls{king} can move his armies through them quickly to quash any rebellion.
He allows trade, and enforces most taxes through the use of portals.

\Gls{king} has decreed that only \gls{college} can build and maintain magical portals.
Everyone loyal to \gls{king} has been instructed to kill anyone who can make such long-range portals on sight, unless they can verify their membership with \gls{college}.\footnote{Putting people who can make magical portals in jail was never an option.}
...
Worst of all, the Bearded Mountains themselves often explode, sending lava flowing downhill and great clouds of smoke and ash into the air.
...
A generation ago, Dogland was a place with sparse human villages, but no large settlements.
...
An empty wasteland sits between the elvish forests and the dwarvish tunnels in the nearby Bearded Mountains region.
