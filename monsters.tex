...
\newcommand{\woodspy}{
	\randomthree
	\person{\arabic{random}}{4}{2}{{-4}{+2}{-5}}{2}{0}{Athletics 2, Stealth 4, Survival 2, Tactics 2}{None}{}
}

\newcommand{\basilisk}{
	\randomthree\addtocounter{age}{5}\randomtwo\addtocounter{list}{1}
	\animal{\arabic{age}}{-2}{3}{0}{4}{2}{Projectiles 1, Athletics 2, \abilities{Odour demands Strength check, TN 9. Acidic breath (1D6-2 Damage).}}{}{\knacks{\unstoppable}}
}
...
\newcommand{\dwarventrader}{
	\randomthree
	\person{0}{1}{-1}{{\ifnumcomp{\value{random}}{=}{2}{1}{0}}{0}{0}}{0}{1}{Crafts \ifodd\value{page} 1 \else 2\fi, Deceit \ifodd\value{page} 2 \else 1\fi}{\shortsword\ifnumcomp{\thechapter}{=}{6}{3D6sp}{\setcounter{gold}{\thepage}, \arabic{gold}sp}}{}
	}
%
...
\newcommand{\elvenenchanter}{
	\randomtwo\setcounter{age}{0}\addtocounter{age}{-\value{list}}
	\person{\arabic{list}}{3}{2}{{3}{3}{3}}{0}{0}{Projectiles 1, Academics 3, Empathy 3, Deceit 3, Performance 3, Stealth 1, Vigilance 2\Path{Blood}{Enchantment 5, Aldaron 4, Metamagic 4, Fate 3, Forces 2, Polymorph 2, Invocation 1}}{%
...
\newcommand{\humanpriest}{
	\randomthree
	\person{\ifnum\value{list}>5 3\else 0\fi}{0}{0}{{\arabic{age}}{0}{\ifodd\thepage 0\else 1}}{0}{\ifnum\value{enc}>3 0 \else 1 \fi}{Academics \arabic{age}, Empathy \ifnum\value{list}<2 2\else 1\fi\Path{Devotion}{Fate \arabic{age}\ifodd\thepage \else \randomtwo Aldaron \arabic{list}\fi}}{\ifodd\thechapter\quarterstaff\else\Dagger\fi}{\multiply\value{age} by 2\mana{\arabic{age}}}
	}
...
\newcommand{\undeadknight}{
	\randomtwo\addtocounter{list}{1}\setcounter{enc}{\value{list}}\addtocounter{list}{-1}
	\person{\arabic{list}}{2}{0}{{\arabic{list}}{0}{-5}}{2}{2}{Aggression 2, Beast Ken 1, Survival 1, Tactics \arabic{age}, Vigilance 1}{\greatsword, dagger, %
...
\newcommand{\demilich}{
	\randomtwo
	\person{\arabic{list}}{-1}{-2}{{2}{1}{-5}}{2}{1}{Aggression 2, Projectiles 1, Academics 3, Deceit 1, Medicine 2, Vigilance 1\Path{Devotion (Qualme)}{Fate \arabic{list}, \ifodd\thechapter Invocation 3\else Aldaron \arabic{list}\fi, Metamagic 3, Necromancy 5}}{\Dagger, mana stone holding 6 MP}{\mana{6}\lockedmana{3}\setcounter{spd}{\value{wts}}}
	}
...
\newcommand{\umberhulk}{
	\randomtwo\addtocounter{list}{4}
	\animal{\arabic{list}}{\ifodd\thechapter -1\else 0\fi\randomtwo }{1}{1}{5}{2}{Stealth 1, Survival \arabic{list}, Vigilance 1}{}{}
	}
...
\newcommand{\archmage}{
	\randomtwo\addtocounter{list}{3}\randomthree
	\person{-5}{-2}{-3}{{\arabic{list}}{4}{-5}}{0}{0}{Projectiles \arabic{age}, Academics 3, Deceit \arabic{age}, Ether Lore \addtocounter{list}{-1}\arabic{list}, Tactics \arabic{age}\Path{Divinity}{Force \arabic{age}, Illusion 3, Invocation 5, Conjuration 4, Metamagic \addtocounter{list}{1}\arabic{list}}}{None}{\addtocounter{sp}{20}\mana{8}\addtocounter{xpbonus}{4}}
	}
