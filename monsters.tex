...
%
%
%input \character with 9 variables: str, dex, spd, {mind}, dr, att, 
%
% set \mind to true and output the character
%      _                          _            
...
\newcommand{\woodspy}{
	\person{0}{4}{2}{{-4}{+2}{-5}}{2}{0}{Athletics 2, Stealth 5, Survival 2, Tactics 2}{None}{}
}
