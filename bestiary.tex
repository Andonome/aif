...
\begin{itemize}
  ...
  \item{One night on watch, a pack of wolves stalks the party. If the watchman fails the Strength + Vigilance check to stay alert, one wolf grabs the smallest party member's backpack and flees.}
...
Woodspies love deer, badgers, humans, and aurochs.
...
\best[\T\Hu\E]{Bandits and Soldiers}
\label{human_soldier}
