...
can present as a stampede.  Wits + Beast Ken is rolled, and failure indicates a given party has very little time to hide.  Anyone remaining in the Path of the stampede rolls Dexterity + Beast Ken, TN 9.  Failure indicates $2D6$ Damage as the marauding mammals trample over the characters.
...
\begin{itemize}
	...
	\item{The party see aurochs peacefully grazing in the distance.}
	\item{Nearby aurochs stampede.
...
\begin{itemize}
	...
	If they fail, the bear immediately attacks until it has secured a meal.}
...
\begin{itemize}
	...
	\item{While the group sleeps, anyone on watch notes quiet movement in the dense trees above, before they see a thin, translucent mucus gently descend upon a sleeping companion.
...
\iftoggle{core}{%
\footnote{See the core book, page \pageref{charge} for more on charging.}
}{}
