...
{0}% DR
{1}% COMBAT
{Projectiles 2, Athletics~1, Deceit 1, Larceny~3, Stealth 1, Survival~1, \mbox{Vigilance~1}\knacks{\precisestrike, \quickshot}}% SKILLS
...
{0}% DR
{2}% COMBAT
{Projectiles 1, Athletics 2, Deceit 1, Survival 2\knacks{\unstoppable, \finishingblow, \charge}}% SKILLS
...
{0}% DR
{0}% COMBAT
{Projectiles 1, Academics 2, Crafts 1, Survival 1\knacks{\combatcaster, \specialist{Intelligence + Projectiles}}\Path{Alchemy}{Conjuration 3, Invocation 3, Illusion 1}}% SKILLS
...
\noindent
The Ale Guild of the Bearded Mountains takes dwarvish ale to \gls{town}, then waters it down, and makes an absolute killing in profits.
...
\iftoggle{core}%
{\footnote{See the core book, page \pageref{teamwork}, for Group Rolls.}}%
{}%
...
\Gls{captain} recently asked a number of guards about recent nura sightings, and why there was suspicious activity in \gls{town}, such as the strange Whitelander accent heard in \gls{pig}.
...
\person{0}% STRENGTH
	...
	{0}% DR
	{0}% COMBAT
	{Academics~1, Empathy~2, Deceit~1, Larceny~2\Path{Devotion (Alass\"{e})}{Fate~2}}% SKILLS
...
\person{0}% STRENGTH
	...
	{2}% DR
	{2}% COMBAT
	{Academics~2, Medicine~1, Stealth~3, Survival~1, Vigilance~3\Path{Devotion}{Aldaron~3, Fate~2, Necromancy~2}}% SKILLS
	{None}% EQUIPMENT
	{\mana{6}\lockedmana{2}}
...
Lockpicking them requires an Intelligence + Larceny Group Roll, TN 10 if the bar's up, and TN 14 otherwise.
