...
\begin{enumerate}\itemsep0em\stepcounter{enumi}
  \item
  Greetfall has managed to save up \lootBig, which he keeps hidden under the floorboards in his room (find it with \roll{Intelligence}{Empathy} at \tn[10]).
  \label{lt:tenderRoom}
  \item
...
Two candles still burn, but the corpse has gone.
\end{exampletext}
