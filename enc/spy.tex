...
\begin{enumerate}\itemsep0em\stepcounter{enumi}
  \item
  Greetfall has managed to save up \lootBig, which he keeps hidden under the floorboards in his room (\act{find it}{Intelligence}{Empathy}{10}).
  \label{lt:tenderRoom}
  \item
...
\act[Anyone on \pgls{vigil}]{hear her descend}{Wits}{Vigilance}{8}
