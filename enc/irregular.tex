...
Trader \marketFence\ arrives at the \gls{broch} that night, and requests aid
from \gls{jotter}~Filchvore, who congratulates the troupe on their mission, and
mentions that \gls{basilisk} bodies can fetch a good price, then reminds them
that half of the sale goes to the \gls{templeOfBeasts}.
