...
If the \glspl{pc} rush out to find the source of the smell, find it \vref{irregularDragon}.

\segment{village}% AREA
{Back Up}% NAME
{The farmers don't want the troupe to stay}% SUMMARY
