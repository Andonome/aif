...
\begin{exampletext}
  Granny grows plants with \gls{witchcraft}, which decreases the soil's fertility until it becomes completely barren.
...
\ifnum\thepage<14
  ...
  become \glspl{npc}.
  \Pgls{cycle} later, the new \glspl{pc} may hear \pgls{doula} in a nearby \gls{village} telling children the chilling tale of `the curious \gls{guard}', or `the man who kept his hat on, while accepting hospitality'.
\fi
