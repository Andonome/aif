...
\vspace{-1.6em}
\mapentry[lair:entrance]{The Entrance}
\begin{boxtext}
...
\sideMap[4]{Dyson_Logos/winding_overview}%
  {%
    \ref{lair:entrance}/80/92,
    \ref{lair:tunnel}/78/72,
...
The muddy slope descends fast, emerging 8~\glspl{step} above \gls{area}~\ref{lair:right}.

\paragraph{Stay balanced}
with \roll{Dexterity}{Caving} at \tn[8], or slip, then fall 8~\glspl{step} down to \gls{area}~\ref{lair:right}.%
