...
\newcommand\pacingExample{
  \begin{figure*}[b!]
    ...
    \begin{multicols}{2}
      ...
      \begin{description}
        \item[3 \glspl{ap}]
        Down the stairs, they investigate the \nameref{fHallStore} (\vpageref{fHallStore}).
        \item[2 \glspl{ap}]
        Upon investigation, the \nameref{fHallStore} looks dangerous.
        \item[1 \glspl{ap}]
        The troupe enter room~\ref{fLift}.
        \par\bigLine
        \item[3 \glspl{ap}]
