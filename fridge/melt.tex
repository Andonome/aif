...
\begin{nametable}{Barrel Roll}
  ...
  \dicef{2} & Ale: inert \\
  \dicef{3} & Wine: safe. \\
  \dicef{4} & Flour: safe, but enough fire and shaking makes it explode for \dmg{4} \\
  \dicef{5} & Larger: pushing makes it explode for \dmg{0}~Damage. \\
  \dicef{6} & Oil: receiving 8 or more Damage makes it burst everywhere for \dmg{0}~Damage. \\
\end{nametable}
...
It takes an age to reload, but it'll deal \dmg{8}~Damage to anything
