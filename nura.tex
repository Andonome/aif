...
\subsection{\Glsfmtlongpl{blight}}
\label{blight}
...
\noindent
A nura invasion might begin with a portal to the nura realm\footnote{See \autopageref{darknessandfire}.}, where goblins, ogres, and other `natural' nura creep through, and begin eating everything for miles around.
...
\spelllevel
\spell{Demonic Form}{Instant}{Xenomology}{The caster can use their spheres as permanent abilities}
