...
\sqpart{Villages}{You See a Deer}{A human has been transformed into a deer, and simply stops to stare at the characters}
...
\sqpart{Forest}{The Green Tower}{The party find people setting up a base of operations in the forest}
...
The top is to be disguised by painting it green (the coloring is made by malachite, which can be expensive).
...
Half of the masons are active members of the Woodspy Bandits, lead by \gls{nightguard}.
...
\Gls{nightguard} has not informed the rest of the Night Guard, such as \gls{captain} of his activities, so if he suspects the characters are acquainted with the Night Guard, he will remain hidden, or start spinning lies about how the place is top secret business of \gls{king}.


See page \pageref{green_tower} for more details.  Move this encounter to the town.

\sqpart{Town}{Rogue Sheep}{The party find a person turned into a sheep}
...
\sqpart{Town}{\Glsentrytext{forestpriest} Exiled}{The town crier announces that \glsentrytext{forestpriest} is a wanted criminal}
...
\sqpart{Villages}{The Crow}{A recently fallen corpse is raised from the dead by a bird with a magical amulet}
...
\sqpart{Forest}{The Undead Horde}{A great load of ghouls have become lost and now wander the forest}
...
\sqpart{Villages}{The Survivors}{A village has been raided, and only followers of Qualm\"{e} have been spared}
...
\sqpart{Villages}{Knight of the Dead}{The necromancer makes a full-on assault on a village}
...
\sqpart{Villages}{Fallen Traders}{A number of traders have fallen to bandits}
...
\sqpart{Villages}{Hidden Eyes}{Bandits watch the characters from the side of the road silently}
...
\sqpart{Villages}{The Feast is Cancelled}{The Immortal Bandits have raided a village during a wedding}
...
\sqpart{Villages}{The Dead Tracker}{A member of the Night Guard sent to track down where the dead have come from has returned as a ghoul}
...
\sqpart{Villages}{The Showdown}{The bandits have finally decided to confront the characters}
...
\sqpart{Town}{Bandits Caught}{The bandits who plagued the countryside have been imprisoned}
...
\sqpart{Villages}{\N Bad Bandits}{Villagers from Redfall are so hungry they have turned to banditry, but they're not very good at it}
...
\sqpart{Villages}{\N Wrong Direction Chickens}{A tradesman is taking chickens \emph{from} town}
...
\sqpart{Town}{The Non-Starter}{\Glsentrytext{nurabaron}'s diplomat asks the party to help him}
...
A single roll prompts a forest encounter, and completing this as a resting action entails wading through two forest encounters.

Once the priest is located, he cannot actually `cast magic' and cure the \gls{nurabaron}.
The cure will involve starving the baron of all food until the magic dissipates, and it is possible the baron will starve during this time.
...
\sqpart{Town}{\N \N The Town Crier}{\Glsentrytext{nurabaron} has been found out, and everyone in town wants the bounty on his head}
...
%\sidequest{The Message}\label{message}
%
%\sqpart{Villages}{The Dead Courier}{The party find a dead courier on the road with a message}
%
%\begin{boxtext}
...
\includesvg{images/Dyson_Logos/redfall_keep.svg}
...
These towers each have two guards with bows, ready to rain arrows down on any intruders.
