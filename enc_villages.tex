...
\humansoldier[\NPC{\M}{Bertrand}{Pessimistic}{Squints}]
...
\humandiplomat[\NPC{\M}{Nathaniel the Diplomat}{Practical}{Scratches nose}\label{nathaniel}]
...
\deephobgoblin[\NPC{\M\N}{Benjie -- ``the Toddler''}{Playful}{Fingers in mouth}]
