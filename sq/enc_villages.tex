...
If he receives the message and believes it to be intact, then he will send \gsl{alchemist} to \gls{greentower} to inspect its progress.
...
\paragraph{Once \gls{forestpriest} is located,}
