...
If he does not receive the message, he will not approach \gls{greentower} until he receives another message, much later.
If he receives the message and believes it to be intact, then he will approach \gls{greentower} to inspect it.
...
\Gls{traitor} has not informed the rest of the \gls{guard}, such as \gls{captain} of his activities, so if he suspects the characters are acquainted with the \gls{guard}, he will remain hidden, or start spinning lies about how the place is top secret business of \gls{king}.
...
If news of their whereabouts is brought to the \gls{guard},\footnote{See page \pageref{guardstation} for more on the guard station.}
...
and add the tower to the map of the area, wherever the party happen to be in the forest.
...
\begin{speechtext}
  ...
  \Gls{nurabaron} had a good relation with the \gls{guard}, and all the hunters in his village provided all manner of information to \gls{townmaster}.
  He had to go.
...
They know that if he's dispossessed, they'll all be out of work, and have to join the \gls{guard}, or worse.
