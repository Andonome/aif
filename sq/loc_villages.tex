...
\mapPic{t}{Dyson_Logos/redfall_keep}{
  ...
  \huge\ref{redTower}/05/08,
  \ref{redYard}/30/50,
  \huge\ref{redToilet}/545/34,
  \ref{redKitchen}/31/75,
  \ref{redServants}/41/75,
  \huge\ref{redChild}/84/19,
  \ref{redSmolYard}/63/36,
  \ref{redHall}/63/75,
}
...
\mapentry[redSmolYard]{The Smaller Courtyard}
...
\mapentry[redHall]{The Great Hall}
...
\mapentry[redStorage]{The Old Storage Shelves}
...
\mapentry[redFamily]{The Hidden Family}
...
\mapPic{t}{Dyson_Logos/lakeside}{
  \ref{lakeSquare}/47/47,
  \ref{lakeTemple}/71/81,
  \ref{lakeDocks}/16/64,
}
