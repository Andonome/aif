...
The only problem is that nobody knows which road the \gls{guard} who carry the Lizardite Amulet will take, so Jared is sending any able-bodied men he can in all directions, each with their own copy of the amulet.
