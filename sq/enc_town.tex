...
\dwarvensoldier[\NPC{\Dw\M}{Guild Captain Laxen}{Dour}{Strokes beard}{Experience}]

\humansoldier[\npc{\T\Hu\E}{Joshua, Rachael and Rob}]

These two are heavy drinkers, and heavy fighters, but they will stop as soon as Captain Laxen gives the word.

\dwarventrader[\npc{\T\Dw\M}{Mugin \& Thunin}]
...
\humansoldier[\npc{\T\Hu\E}{Five members of the \glsentrytext{guard}}]

\humansoldier[\npc{\T\Hu\E}{Ten of the Woodspy Bandits}]
...
As soon as he's gone, three of the \gls{town} \gls{guard} bound round the corner in pursuit, shouting at the characters to get him.
...
Havoc broke out, and the \gls{pig} is closed until further notice.
...
\footnote{See area 5 on the \gls{town} map.}
...
\humanthief[\npc{\T\E\Hu}{Four of the Sewer Thieves}]
...
they have 8 rounds before the ghouls devour him, and will need to travel across 20 squares before reaching the \gls{townmaster}'s room on the second floor.
