...
\NPC{\M}{Chris, Ale Guild Journeyman}{Angry}{Pointing at people}{Alass\"e}
...
\magicitem{The Lizardite Amulet}{Conjuration 3}{Alchemy}{Continuous}{Artefact}{5}{30}
...
\sqpart{Town}% AREA
{The Shell Game}% NAME
{The characters must take a fake magical amulet to the \glsentrytext{guard} so it can be swapped for the real one}% SUMMARY
...
Chief alchemist \gls{alchemist}, of \gls{town}'s citadel, has arranged for three replicas to be created, and has transported them to the town.%
\footnote{See page \pageref{citadel_alchemist} for \gls{alchemist}.}
...
The only problem is that nobody knows which road the \gls{guard} who carry the Lizardite Amulet will take, so \gls{alchemist} is sending any able-bodied men he can in all directions, each with their own copy of the amulet.

\Gls{captain} is going around giving speeches to quickly recruit people for a mission.

If the characters are part of the \gls{guard}, they must take the mission.
If not, they will be instantly deputized, and have to take the mission (but can expect financial compensation).

\begin{boxtext}

  You see \gls{captain} talking to a group of the \gls{guard} nearby.
  ...
  Once the captain has finished his speech, he hands over a green amulet to the group of men wearing chain armour -- apparently members of the \gls{guard}.
  He then turns, spots you, and approaches.

  \begin{quotation}

    Men, the king has appointed you to carry out an immediate mission.
    This Alchemical Amulet must be delivered immediately to a group of the \gls{guard} coming up from the South.
...
\paragraph{The Amulet Bearers} are five brave members of the \gls{guard} who have ridden for a long time.
...
\humansoldier[\npc{\T}{Five members of the \glsentrytext{guard}}]
...
They get their information from a traitorous member of the \gls{guard} -- Darren.%
...
They might go towards the \gls{guard}, in which case they have a moment to speak, and then the bandits attack.

Alternatively, they may just wait at the crossroads, in which case the bandits see them, then surround them quietly.
If the party aren't wearing the \gls{guard} uniform, they bandits assume they are nothing to do with the \gls{guard} and wander off quietly\ldots assuming the characters don't spot the abortive ambush and make trouble.
...
The actual Lizardite Amulet taken by a loyal group of the \gls{guard}, but soon after they were killed by ghouls created by \gls{necromancer}.
