...
\mapPic[\Large]{t}{Dyson_Logos/town}{
  ...
  5/14/71,
  6/22/80,
  \rotatebox{0}{\footnotesize Paper Guild}/40/35,
  \rotatebox{9}{\footnotesize Big Docks}/40/52,
  \rotatebox{-9}{\footnotesize Shale Dock}/60/52,
  \rotatebox{-90}{\footnotesize Windy Bridge}/505/49,
  \rotatebox{-54}{\footnotesize Citadel Bridge}/30/45,
  \rotatebox{-9}{\scriptsize Cowbridge}/47/675,
  \rotatebox{-1}{\scriptsize Sheepbridge}/50/78,
  \rotatebox{-90}{\footnotesize Spy Grate}/75/47,
}
...
\begin{rollchart}
  ...
  6 & Temple of Ohta. \\
  7 & Temple of C\'al\"e. \label{townPaperTemple}\\
...
\mapPic{t}{Dyson_Logos/sewer}{
  \ref{butcher_exit}/20/95,
  \ref{sewerCells}/21/75,
  \ref{sewerLockup}/09/41,
  \ref{sewerLockup}/37/03,
  \ref{oldlibrary}/28/49,
  \ref{sewerArtefacts}/86/63,
  \large S/83/65,
  \Large\ref{sewerKingRoom}/71/51,
  \Large\ref{sewerDust}/70/33,
  \ref{sewerWaterHall}/48/36,
  \ref{sewerLockup}/61/42,
  \ref{sewerCells}/51/06,
  \Large\ref{sewerFood}/70/69,
  \ref{underHall}/77/27,
  \ref{citadelTunnel}/11/13,
  \ref{sewerCells}/21/16,
  \ref{sewerPigWalk}/85/80,
  \ref{sewerPig}/92/74,
  \ref{farmExit}/71/97,
  \Large\ref{sewerDust}/49/76,
  \Large\ref{underGuard}/63/865,
  \ref{sewerCells}/43/79,
  \ref{sewerShrine}/56/77,
  \Large\ref{sewerDog}/33/66,
}
...
\mapentry[sewerWaterHall]{The Drowned Hallway}
