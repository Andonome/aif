...
\mapPic[\Large]{t}{Dyson_Logos/town}{\Huge 1/102/50,2/13/58,3/67/25,4/20/77,5/14/71,6/22/80}
...
\mapPic{b}{Daniel_Walthall/prison}{
  ...
  \ref{guardStationRoom}/21/23,
  \ref{mainPrisonRoom}/56/50,
  \ref{dunCells}/71/79,
  \ref{dunCells}/71/21,
  \ref{dunGrate}/88/50,
  \ref{thingsRoom}/88/79,
  \ref{ogreCell}/88/21,
  }
...
It leads down to room \ref{pigexit} in \lowercase{\nameref{sewers}} (page \pageref{pigexit}).

\mapentry{Prisoners' Possessions}
\label{thingsRoom}
...
\mapPic{b}{Dyson_Logos/mincing_pig}{
  ...
  \ref{pigShaft}/52/58,
  \ref{pigTemple}/74/73,
  \huge\ref{pigDogs}/84/33,
  \ref{pigDown}/87/01,
}

\mapentry{Outside Street}
\label{pigStreet}
