...
\mapPic{t}{Dyson_Logos/qualme_temple}{
  \ref{antGrounds}/17/24,
  \ref{antHall}/37/51,
  \ref{antBasilisk}/52/61,
  \ref{antPrison}/37/91,
  \ref{antCamp}/24/82,
  \ref{antOgre}/86/24,
  \ref{antTower}/59/10,
...
\mapPic{b}{Dyson_Logos/under_lost_city}{
  \ref{alchemyHall}/18/85,
  \ref{alchemyEquipment}/18/59,
  \ref{alchemyLibrary}/52/73,
  \ref{alchemyRooms}/30/37,
  \Large A/18/37,
  \Large B/42/37,
  \Large C/30/18,
  \ref{alchemySecret}/73/85,
  \ref{alchemyGift}/60/37,
  \ref{summoningRoom}/90/59,
}

\mapentry[alchemyEquipment]{Equipment Room}
...
\mapentry[alchemyRooms]{The Masters' Quarters}
...
\mapPic{b}{Dyson_Logos/green_secret}{
  \ref{underGreenTower}/13/50,
  \ref{underWatcher}/14/04,
  \ref{underPriests}/265/54,
  \ref{underDoors}/45/40,
  \ref{underSideRoom}/56/72,
  \ref{underSpiral}/89/43,
  \rotatebox{25}{\ref{Abyss}: \nameref{Abyss}}/67/49,
}
...
\paragraph{Background:}
The tomb is guarded by a knight who stands in a side-cupboard, sworn to guard the golden priests.
...
If the characters enter with the Torpor spell cast, or rings of asphyxiation, they will be able to pass Jabril and the Golden Priests invisibly, so long as they do not linger too close to any of them.
...
\mapentry[underDoors]{The Exposed Doors}
...
\mapentry[underSpiral]{The Downward Spiral}
