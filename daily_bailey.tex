...
\newcommand\afterBaileyEvent{%
  ...
  \else% 6
    ...
    \else
      \appto{\baileyback}{%
        Long after Sunset, a trader's voice booms out prices for ropes and meats, then stops half-way through the sentence.
        ...
        If more then two people attack the \glspl{griffin}, they fly away.
