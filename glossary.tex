...
\newglossaryentry{cleverbaron}{name={Bob Village master},text={Lord Bob},first={Lord Robert},description={is a villagemaster, currently plotting to overthrow the king by collecting magical items from the nura}}
...
\newglossaryentry{townmaster}{name={Also Bob},text={also Bob},first={Bob, Lord of all town},description={rules the local town, and takes steep taxes from the local Villagemasters.  He's an approachable and fun fellow, but generally hated by everyone who knows his tax collectors better than they know him}}
...
\newglossaryentry{whitehorse}{name={The White Horse},text={the White Horse},first={the White Horse},description={is a serene and esteemed establishment, with a reputation for high-quality clientel}}
