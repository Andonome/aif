...
\person{0}% STRENGTH
  ...
  \knacks{\bloodCaster, \divineCaster (Alass\"e)}
...
\newglossaryentry{alchemist}{
  name={Jared},
  description={works for \glsentrytext{townmaster} as an alchemist in \glsentrytext{town}'s citadel}
}
