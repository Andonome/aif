...
\newglossaryentry{edge}{
  ...
  sort={Edge},
  text={Edge},
  first={the Edge of Civilization},
...
\newcommand{\alemaster}{
  \NPC{\F}{\Glsfmttext{alemaster}}{Playing dim}{Humming between sentences}{Alass\"e} 
...
\newglossaryentry{beardedalemaster}{
  name={Susan},
  first={Ale Master Susan of the Shale},
  text={Susan},
...
\NPC{\M}{\Glsentrytext{forestpriest}}{Precise}{Looks down}{Laiqu\"e} 
...
\person{0}% STRENGTH
  ...
  \Path{\aldaron~2, \fate~3, \polymorph~4}}% SKILLS
...
\NPC{\M}{\Glsentrytext{sewerking}}{Benevolent Leader}{Hands on sword}{Experience}
...
\newcommand{\sewerthief}{
  \label{sewerthief}
  \NPC{\M}{\Glsfmttext{sewerthief}}{Cheeky}{Grins wide}{Tribe}
