...
\person{5}% STRENGTH
	...
	{0}% DR
	{1}% COMBAT
	{Academics~1, Beast~Ken~1, Deceit~2\knacks{\adrenalinesurge}}% SKILLS
...
\person{2}% STRENGTH
	...
	{0}% DR
	{2}% COMBAT
	{Athletics~2, Beast~Ken~1, Deceit~1, Larceny~1, Survival~2\knacks{\adrenalinesurge, \disarm, \Defender, \furiousblows}}% SKILLS
