...
\humandiplomat[\NPC{\F}{\glsentrytext{beardedalemaster}}{Inquisitive}{Hands behind her back}]
}
...
\newcommand{\keras}{
	\gnomishillusionist[\NPC{\M}{\glsentrytext{keras} the Gnomish Illusionist}{Sly}{Waggles finger}]
}
...
\Path{Devotion (Qualm\"{e})}{Aldaron 3, Fate 2, Metamagic 3, Necromancy 5}}%SKILLS
...
\newcommand{\townmaster}{
	\humandiplomat[\NPC{\M}{\glsentrytext{townmaster}}{Enthusiastic}{Snorts, loudly}]
}
...
\person{1}{3}{2}{{1}{-1}{0}}{0}{3}{Academics 1, Beast Ken 1, Crafts 2, Deceit 3, Tactics 2, Vigilance 2\knacks{\adrenalinesurge, Specialist (Speed + Athletics)}}{\longsword, \partialleather, two daggers, 40sp}{}
}
...
{0}% DR
{2}% COMBAT
{Deceit 2, Larceny 2, Stealth 1, Survival 1, Vigilance 2\knacks{\stunningstrike, \perfectsneakattack}}% SKILLS
